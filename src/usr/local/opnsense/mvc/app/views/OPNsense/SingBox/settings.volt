...
<div class="alert alert-info" role="alert">
    ...
    Сохранение параметров не изменяет рабочий <code>config.json</code>. Перед применением можно проверить сводку, предупреждения и технический preview. При работающей службе применение включает контролируемый перезапуск и откат предыдущего состояния при ошибке.
</div>
