...
grep -Fq 'usr/local/opnsense/scripts/OPNsense/SingBox/system_resolver.php' "$BUILD_SCRIPT"
...
grep -Fq 'system_resolver.php' "$REGRESSION_SCRIPT"
grep -Fq '/etc/resolv.conf' "$REGRESSION_SCRIPT"
grep -Fq 'system_resolvconf_generate()' "$REGRESSION_SCRIPT"
