...
assertPolicySame(true, $selectedPlan['dns_redirect']['ready'], 'DNS redirect selected mode с клиентами');
...
assertPolicySame('dns-redirect-udp', $udpOperation['id'] ?? null, 'ID UDP DNS redirect');
...
assertPolicySame('dns-redirect-tcp', $tcpOperation['id'] ?? null, 'ID TCP DNS redirect');
...
assertPolicySame(true, $allLanPlan['dns_redirect']['ready'], 'All LAN DNS redirect формируется без source selectors');
...
echo "Декларативный policy-план OPNsense проверен\n";
